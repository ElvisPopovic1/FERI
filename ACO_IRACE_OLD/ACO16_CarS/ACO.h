...
struct ant
{
    ...
    */
    ...
    uint usedNeighbours; //max neighbour on path (neighbours are sorted)
...
struct bestPath
{
    ...
    double pheroMin1, pheroMax1; //nodes pheromones min and max values and ratio
    double pheroMin2, pheroMax2; //cars pheromones min and max values and ratio
