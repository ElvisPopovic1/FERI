...
{
    cout << setprecision(5) << prData.name << ", type: " << prData.type << ", nodes: " << prData.dim << ", cars: " << prData.nCars << ", passengers: " << prData.nPass << endl;
    ...
    ", rho3: " << parData.rho3 << 
    ", alpha3: " << parData.alpha3 << ", beta3: " << parData.beta3 << 
    ", pheroNodeRatio: " << parData.minRatioNodes << ", pheroCarsRatio: " << parData.minRatioCars  << endl;
...
{
    cout << setprecision(5) << "it. " << bPath.iteration << ", time: " << cur_time.count() << " s" <<
    ...
    ", nodes phero ratio: " << parData.minRatioNodes <<
    ", cars phero Min: " << bPath.pheroMin2 << ", cars phero Max: " << bPath.pheroMax2 << 
     ", cars phero ratio: " << parData.minRatioCars << ", used neighbours: " << bPath.usedNeighbours << endl;
}
